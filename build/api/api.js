...
var utils_1 = require("../utils"); // Adjust import based on your setup
var router = (0, express_1.Router)();
// Main route to render the index.ejs with a list of images
router.get('/', function (req, res) {
    var imagesDir = path_1.default.join(__dirname, '../images/full');
    var images = fs_1.default.readdirSync(imagesDir);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fs_1.default.promises.mkdir(thumbDir, { recursive: true })];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: 
            // Resize the image and save it in the thumb directory
            return [4 /*yield*/, (0, utils_1.resize)(filename, height, width)];
            case 3:
                // Resize the image and save it in the thumb directory
                _a.sent();
